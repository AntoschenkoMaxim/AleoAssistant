...
export function Header() {
  return (
    <header className='flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full bg-white border-b border-gray-200 text-sm py-3 sm:py-0 dark:bg-space-gray dark:border-space-purple/35'>
      <nav
